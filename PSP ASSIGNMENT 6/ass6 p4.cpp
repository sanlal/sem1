//Q4 4.	Create a structure for calender date with day, month and year.
// Find if given two days are equal, or which is earlier.
// Write a function to add days to the date structure to form the new date. Assume no leap year.
#include <iostream>
#include <string>
