//Q2.	Create a structure for Bank account with name, account number and balance. 
//Create a list of account holders using array of structures and get input from user to populate them.
// Display the account details given the account number.
